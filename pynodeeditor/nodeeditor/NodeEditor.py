...
from nodeeditor.NodeEditorAppView import NodeEditorAppView
...
class NodeEditor(QMainWindow):
    ...
    def initUI(self):
        ...
        editMenu.addAction(self.createAct(
            'Cu&t', 'Ctrl+X', "Cut to clipboard", self.onEditCut))
        editMenu.addAction(self.createAct('&Copy', 'Ctrl+C',
                                          "Copy to clipboard", self.onEditCopy))
        editMenu.addAction(self.createAct(
            '&Paste', 'Ctrl+V', "Paste from clipboard", self.onEditPaste))
        editMenu.addSeparator()
        editMenu.addAction(self.createAct(
            '&Delete', 'Del', "Delete selected items", self.onEditDelete))

        # create node editor widget
        nodeeditor = NodeEditorAppView(self)
